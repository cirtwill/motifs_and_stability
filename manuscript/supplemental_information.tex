...
\section*{S6: Relating motif participation to simple roles}
	...
	\subsection*{Methods}
		...
		Not sure any simplification necessary in main text?
...
\section*{SA: Relating motif participation to persistence}
...
% # Alpha order of names is S5, S4, S2, S1
	...
	\subsection*{Network-normalised ($Z$-score) motif participation}
		...
		Having a higher $Z$-score in any motif was associated with greater persistence (longer mean time to extinction; Table~\ref{tab:persistence_Z}).
		These trends explained most variation in persistence for apparent competition, omnivory, and the three-species chain.
		...
		\begin{tabular}{l | c c}
		 Motif & $\beta$ & $p$-value \\  
		 \hline
		 Intercept & 3.465e+01 & \textless0.001 \\
		 \hline
		 Apparent competition & 1.524e+00 & \textless0.001 \\
		 Direct competition &  4.615e-01  & \textless0.001 \\
		 Omnivory & -3.590e-01  & \textless0.001 \\
		 Three-species chain & 1.497e+00 & \textless0.001 \\
		 Other &  1.968e-01  & \textless0.001 \\
		 \hline
		 Variance explained & \multicolumn{2}{c}{$R^{2}_m$=0.02151959; $R^{2}_c$=0.05085696} \\
		 \hline
		 \end{tabular}
		 \end{table}
