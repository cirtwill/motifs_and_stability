...
\section*{S5: Pooling loop-containing motifs [[Do these make sense?]]}
	...
	The motifs containing loops (two-way interactions or three-species loops) are rare in both empirical systems~\citep{StoufferXXXX} and our simulated networks (\%-\%) and are all unstable when modelled in isolation~\citep{BorrelliXXXX}.
