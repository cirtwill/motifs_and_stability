...
\section*{S5: Details of Mantel methods and results}
	...
	\subsection*{Methods}
		...
		Due to computational constraints, we used fewer permutations to calculate $p$-values in the larger networks,
		For networks containing 50-60 species, we calculated significance based on 999 permutations.
		For networks containing 70-80 species, we calculated significance based on 499 permutations.
		For networks containing 90-100 species, we calculated significance based on 99 permutations.
