...
\section*{Table of Contents} [[check fig. numbers]]
    ...
    \subsection*{S5: Details of Mantel methods and results}
    	...
    	Supplemental methods and results for Mantel tests relating dissimilarity in motif participation to differences in mean times to extinction. Includes \textbf{Figures SX-SX, Tables SX-SX}.
...
\section*{S5: Details of Mantel methods and results}
	...
	\subsection*{Results}
		...
		[[big table of test statistics, p-values]]

		[[figure showing generally high correlations]]
