	...
	\subsection*{Statistical Analysis}
        ...
        \subsubsection*{Is motif participation related to persistence?}
            ...
            \textbf{Motif participation as a whole}
                ...
                \DIFaddbegin \DIFadd{The Mantel tests did not suffer from the same violation of assumptions but also mask which motif participation vectors are associated with high or low extinction risk; we therefore consider these tests likewise indicative but not conclusive (see }\emph{\DIFadd{Appendix S5}}\DIFadd{).
}\DIFaddend 
...
\section*{Results}
    ...
    \subsection*{Motif participation was related to persistence}
		...
		Our series of PERMANOVA tests demonstrated that species' overall motif roles (raw, species-normalised, and network-normalised) were correlated with their mean time to extinction across all combinations of species richness and connectance (Fig. \emph{\DIFdelbegin \DIFdel{S1}\DIFdelend \DIFaddbegin \DIFadd{S2}\DIFaddend }, Tables \emph{TS1-S3, Appendix S3}). 
		...
		However, some of these significant results are likely false positives since the variability of raw motif roles was not consistent across mean times to extinction for most combinations of species richness and connectance (Tables \emph{\DIFdelbegin \DIFdel{S4-6}\DIFdelend \DIFaddbegin \DIFadd{S4-S6}\DIFaddend , Appendix S4}). 
