...
Fig. 5-X (SI except for one focal fig) - non-motif property on y axis, motif on x. One for each motif version and property (could combine in some interesting but simple way).


Fig. Persistence vs. degree, TL, their interaction. Could have as a 4th panel for Fig. 2-4?
