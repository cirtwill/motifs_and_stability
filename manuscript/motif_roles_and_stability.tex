...
\section{Results}
	...
	\subsection*{Consistency of time to extinction across removals}
		...
		\begin{figure}[h!]
			...
			\includegraphics[width=.75\textwidth]{figures/extinction_order/extorder_correlations_paper_full.eps}
			\end{figure}
    ...
    \subsection*{Relating overall motif roles to mean time to extinction}
		...
		The four stable motifs had very coefficients within the model, indicating that each additional instance of a stable motif in a species role contributes relatively little to its persistence. 
		...
		More occurrences of motifs D1, D2, and D6 were also associated with longer mean times to extinction and, for species with very high frequencies of these motifs, these effecs had similar magnitudes to those of the four stable motifs.
	...
	\subsection*{Identifying the motifs most strongly related to mean time to extinction}
        ...
        After testing whether species' motif roles overall were related to mean times to extinction, we tried to a) identify the motifs which were most strongly associated with persistence. 
...
\section{Discussion}
	...
	\subsection*{Overall summary paragraph}
		...
		Time to extinction was quite consistent across removals, suggesting that the properties of species that are not subject to a perturbation are important predictors of stability, as well as the properties of the removed species~\citep{KateThesis}.
		...
		The set of motifs that was most strongly associated with mean time to extinction varied depending on the normalization used, suggesting that both participating in more/less of a given motif than other species in the focal network and the extent to which a focal species' role is dominated by different motifs affect the species' persistence.
	...
	\subsection*{Roles do relate to extinction risk, but interpretation is difficult}
		...
		Participation in all five one-way motifs, as well as motifs D1, D3, and D6 were associated with longer times to extinction. 
	...
	\subsection*{Adding other predictors adds more complications}
		...
		These contrasting effects of motifs which are stable in isolation~\citep{Borrelli2015a} suggest that using a species' degree-normalised motif role to predict stability is not as simple as adding up the contributions of motifs which are stable in isolation.
