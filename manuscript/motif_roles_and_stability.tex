...
\section*{Discussion}
	...
	\subsection*{Motif roles relate to extinction risk}
        ...
        Note however, that in all cases the counts, frequencies, or $Z$-scores of the four most stable motifs~\citep{Borrelli2015a} were most strongly associated with persistence time.
    ...
    \subsection*{Speculation and alternative viewpoints}
        ...
        We note that our simulations reflect only body-mass structured vertebrate food webs, we note that 
        ...
        This will lead to species roles dominated by different motifs and positions.
        Nevertheless, as our four focal motifs are the most common in a variety of empirical networks~\citep{Stouffer2007} we expect that positions within them will remain important regardless of the type of food web under investigation.
        ...
        This could make it more difficult to detect relationships between motif roles and persistence if persistence times became more similar across species, but we do not expect that \emph{which} motifs are associated with persistence would change.
