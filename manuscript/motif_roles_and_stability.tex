...
\section{Introduction}
	...
	[[these 4 motifs are not necessarily intuitive - lots of confusion about omnivory especially (generalism? eating plants + animals? Add a citation to food web omnivory.). Link to Fig. 1.]]
    [[Still may need an explanation of why 3sp motifs somewhere... maybe methods.]]
    
    \begin{figure}[hb!]
    [[Lots of comments on how this could be a very large box.]]
        \centering
        \includegraphics[width=.75\textwidth]{figures/motifs.eps}
        \caption{There are 13 unique three-species motifs. Five (S1-S5) contain only one-way links, while the remainder (D1-D7) contain at least one two-way link. Motifs S1, S2, S4, and S5 are over-represented in empirical food webs and more stable when modelled in isolation. [[Add conceptual fig. highlighting stable motifs, examples of a couple with real taxa]]}
