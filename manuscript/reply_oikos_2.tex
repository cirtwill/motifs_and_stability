...
\section*{Reply to Reviewer 1}
  ...
  \subsection*{Major comments:}
    ...
    2. Suggestion to use a Mantel test instead of PERMANOVA
      ...
      We therefore present these results in the SI for any who are interested but have not addressed them in the main text, and have also moved the PERMANOVA results to the SI at the same time.
